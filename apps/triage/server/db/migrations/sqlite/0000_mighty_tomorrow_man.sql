CREATE TABLE `categorize_categorize_layouts` (
...
CREATE TABLE `triage_flows` (
	...
	`anthropicApiKeyHint` text,
	`aiSummaryPrompt` text,
	`aiTaskPrompt` text,
	`replyPersonality` text,
	`personalityIcon` text,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `triage_tasks_team_notion_page_id_idx` ON `triage_tasks` (`teamId`,`notionPageId`);--> statement-breakpoint
