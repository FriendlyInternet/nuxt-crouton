 ...
 *
 * ## AI Context
 * - Main interface: WidgetPart
 * - Form data type: WidgetPartFormData
 * - New item type: NewWidgetPart
 * - Form props: WidgetPartFormProps
 * - Fields: title, qty
 *
...
import type { widgetPartSchema } from './app/composables/useWidgetParts'
...
export type WidgetPartFormData = z.infer<typeof widgetPartSchema>
...
export type NewWidgetPart = NullableOptionals<Omit<WidgetPart, 'id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'updatedBy'>> & { id?: string; createdBy?: string; updatedBy?: string }

// Props type for the Form component
export interface WidgetPartFormProps {
  items: string[] // Array of IDs for delete action
  activeItem: WidgetPart | Record<string, never> // WidgetPart for update, empty object for create
  collection: string
  loading: string
