 ...
 *
 * ## AI Context
 * - Main interface: TrinketItem
 * - Form data type: TrinketItemFormData
 * - New item type: NewTrinketItem
 * - Form props: TrinketItemFormProps
...
import type { trinketItemSchema } from './app/composables/useTrinketItems'
...
export type TrinketItemFormData = z.infer<typeof trinketItemSchema>
...
export type NewTrinketItem = NullableOptionals<Omit<TrinketItem, 'id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'updatedBy'>> & { id?: string; createdBy?: string; updatedBy?: string }

// Props type for the Form component
export interface TrinketItemFormProps {
  items: string[] // Array of IDs for delete action
  activeItem: TrinketItem | Record<string, never> // TrinketItem for update, empty object for create
  collection: string
  loading: string
