 ...
 *
 * ## AI Context
 * - Main interface: MainPlate
 * - Form data type: MainPlateFormData
 * - New item type: NewMainPlate
 * - Form props: MainPlateFormProps
 * - Fields: name, weight
 *
...
import type { mainPlateSchema } from './app/composables/useMainPlates'

export interface MainPlate {
  id: string
  teamId: string
  owner: string
  name: string
...
export type MainPlateFormData = z.infer<typeof mainPlateSchema>
...
export type NewMainPlate = NullableOptionals<Omit<MainPlate, 'id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'updatedBy'>> & { id?: string; createdBy?: string; updatedBy?: string }

// Props type for the Form component
export interface MainPlateFormProps {
  items: string[] // Array of IDs for delete action
  activeItem: MainPlate | Record<string, never> // MainPlate for update, empty object for create
  collection: string
  loading: string
